...
En utilisant la formule de linérisation [^n1].  
...
[^n1]: demonstration formule de linerisationgrâce aux formules d'Euler [^n2]  
...
Rappelons nous des dérivés $\frac{u}{v}'=\frac{u'v-uv'}{v^{2}}$ et également que si une dérivée est 0 sur tout le domaine de définition de $f$ alors la fonction $f$ est constante sur son domaine de définition.  
...
$f'(x)= 0$ ce qui implique que la fonction est constante.  

En valeur $x=0 => f(0)=1$ cela implique que $e^{ix}=cos(x)+i.sin(x)$