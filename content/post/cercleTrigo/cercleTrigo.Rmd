...
[^n1]: demonstration formule de linerisation grâce aux formules d'Euler [^n2]  
...
$f'(x)= 0$  
Cela implique que la fonction est constante, en valeur $x=0 => f(0)=1$   Nous avons donc $e^{ix}=cos(x)+i.sin(x)$